...
public class ReadCumulativeSummaryService implements
    BaseService<ReadCumulativeSummaryService.ReadCumulativeSummaryRequest, ReadCumulativeSummaryService.ReadCumulativeSummaryResponse> {
    ...
    private ReadCumulativeSummaryResponse.CumulativeSummary readCumulativeSummary(
        ...
        return quizTypeSummaryList.stream()
            .collect(Collectors.teeing(
                ...
                (solved, correct) -> new ReadCumulativeSummaryResponse.CumulativeSummary(solved,
    ...
    @AllArgsConstructor
    @ToString
    public static class ReadCumulativeSummaryResponse extends
        BaseResponse<ReadCumulativeSummaryErrorCode> {
