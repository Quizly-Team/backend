...
public class ReadDashboardController {
    ...
    private ReadDashboardResponse toResponse(
        ReadDashboardService.ReadDashboardServiceResponse serviceResponse) {
        ...
        List<QuizTypeSummary> quizTypeSummaryList = serviceResponse.getQuizTypeSummaryList()
            .stream()
        ...
        List<ReadDashboardResponse.TopicSummary> topicSummaryList = serviceResponse.getTopicSummaryList()
            .stream()
