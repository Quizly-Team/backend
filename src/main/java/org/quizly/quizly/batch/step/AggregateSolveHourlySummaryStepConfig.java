...
import org.quizly.quizly.core.domain.repository.SolveHistoryStatisticsRepository.HourlySummary;
        ...
        return user -> {
            try {
                ...
                List<HourlySummary> hourlySummaryList =
                    solveHistoryStatisticsRepository.findFirstAttemptsHourlySummaryByUserAndDate(
                        user, targetDate);
                ...
                log.error(
                    "[AggregateSolveHourlySummaryProcessor] Failed for user: {}, targetDate: {}",
