...
public class CreateGuestQuizzesService implements
    BaseService<CreateGuestQuizzesRequest, CreateGuestQuizzesResponse> {
    ...
    @AllArgsConstructor
    @ToString
    public static class CreateGuestQuizzesResponse extends
        BaseResponse<CreateGuestQuizzesErrorCode> {
