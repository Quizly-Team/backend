...
import org.quizly.quizly.core.domain.repository.SolveHistoryRepository;
...
public class ReadWrongQuizzesService implements
    BaseService<ReadWrongQuizzesRequest, ReadWrongQuizzesResponse> {
    ...
    public ReadWrongQuizzesResponse execute(ReadWrongQuizzesRequest request) {
        ...
        if ("topic".equalsIgnoreCase(request.getGroupType())) {
            Page<String> topicPage = solveHistoryRepository.findDistinctWrongQuizTopicsByUser(user,
                pageRequest);
            ...
            Page<LocalDate> datePage = solveHistoryRepository.findDistinctWrongQuizDatesByUser(user,
                pageRequest);
