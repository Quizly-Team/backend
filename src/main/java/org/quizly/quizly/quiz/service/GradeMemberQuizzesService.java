...
import org.quizly.quizly.core.domain.repository.QuizRepository;
...
public class GradeMemberQuizzesService implements
    ...
    public GradeMemberQuizzesResponse execute(GradeMemberQuizzesRequest request) {
        ...
        updateSolveHistory(existingHistory.get(), request.getUserAnswer(), isCorrect,
    ...
    @AllArgsConstructor
    @ToString
    public static class GradeMemberQuizzesResponse extends
        BaseResponse<GradeMemberQuizzesErrorCode> {
